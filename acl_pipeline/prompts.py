...
def build_judge_batch_messages(
    ...
    system_prompt = (
        ...
        "If the broken code/task is mindless, contradictory, already correct, unsolvable from the given information, or otherwise poor Red output, mark the task unusable for Socratic training.\n"
        "If the task is valid but the assistant hint is malformed, confusing, hallucinatory, or not useful for debugging, mark only the hint unusable.\n"
